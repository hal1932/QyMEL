...
class FileSelectionWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.accept_mode = FileSelectionWidget.ACCEPT_OPEN
        self.target = FileSelectionWidget.TARGET_FILE
    ...
    def __select_path(self):
        ...
        if self.accept_mode == FileSelectionWidget.ACCEPT_OPEN:
            dialog.setAcceptMode(QFileDialog.AcceptOpen)
        elif self.accept_mode == FileSelectionWidget.ACCEPT_SAVE:
            dialog.setAcceptMode(QFileDialog.AcceptSave)
        else:
            raise RuntimeError('invalid accept_mode: {}'.format(self.accept_mode))

        if self.target == FileSelectionWidget.TARGET_FILE:
            if self.accept_mode == FileSelectionWidget.ACCEPT_SAVE:
        ...
        elif self.target == FileSelectionWidget.TARGET_DIRECTORY:
